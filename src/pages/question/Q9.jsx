...
const Q9 = () => {
  ...
  const questions = [
    "ช่วงนี้มีบ้างไหม ที่รู้สึกเบื่อ ๆ หรือไม่ค่อยอยากทำอะไรเลย รู้สึกว่าอะไร ๆ ก็ไม่ค่อยน่าสนใจเท่าไหร่",
    "มีช่วงไหนไหม ที่รู้สึกไม่ค่อยสบายใจ เศร้า หรือเหมือนใจมันเหนื่อย ๆ ท้อ ๆ บ้าง",
    "ช่วงนี้การพักผ่อนเป็นยังไงบ้าง หลับยากหรือเปล่า ตื่นบ่อย หรือนอนเยอะกว่าปกติบ้างไหม",
    "รู้สึกเหนื่อยง่าย หรือเหมือนไม่ค่อยมีแรงจะทำอะไรบ้างไหมช่วงที่ผ่านมา",
    "ช่วงนี้รู้สึกไม่อยากกินอะไรเลย หรือเผลอกินเยอะกว่าปกติบ้างไหม",
    "เคยรู้สึกไม่ค่อยดีกับตัวเองบ้างไหม แบบที่รู้สึกผิดหรือเหมือนทำให้ตัวเองหรือคนรอบข้างผิดหวัง",
    "มีช่วงที่รู้สึกว่าจดจ่อกับอะไรไม่ค่อยได้ไหม อย่างดูทีวี ฟังเพลง หรือทำงานที่ต้องใช้สมาธิ",
    "รู้สึกไหม ว่าช่วงนี้ตัวเองทำอะไรช้าลง หรือกลับกันคือกระสับกระส่าย อยู่นิ่ง ๆ ไม่ค่อยได้",
    "เคยมีความคิดแว้บเข้ามาไหม ว่าถ้าหายไป หรือไม่ได้อยู่ตรงนี้แล้วมันอาจจะดีกว่า",
  ];
