...
const Q9 = () => {
  ...
  const questions = [
    ...
    "พักผ่อนเป็นยังไงบ้าง ช่วงนี้? หลับยาก ตื่นบ่อย หรือนอนเยอะกว่าปกติไปหน่อยบ้างไหมเอ่ย",
    "รู้สึกเหนื่อยง่าย หรือเหมือนไม่ค่อยมีแรงจะทำอะไรบ้างไหมคะช่วงที่ผ่านมา",
    "เรื่องกินโอเคไหม? มีช่วงที่รู้สึกไม่อยากกินอะไรเลย หรือเผลอกินเยอะกว่าปกติบ้างไหม",
