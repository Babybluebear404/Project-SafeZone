    ...
    <div className="screeningCase">
      {result === null ? (
        <>
          ...
          <div>
            <p>💕 ช่วง 2 สัปดาห์ที่ผ่านมา มีช่วงไหนที่รู้สึกเศร้า หดหู่ หรือเหมือนไม่ค่อยมีพลังใจบ้างไหม?</p>
            <div>
              <label>
                <input
                  type="radio"
          ...
          <div>
            <p > 💕ช่วง 2 สัปดาห์ที่ผ่านมา มีความรู้สึกเบื่อ ๆ หรือทำอะไรก็ไม่ค่อยรู้สึกสนุกเหมือนเดิมบ้างไหม?</p>
            <div>
              <label>
                <input
                  type="radio"
