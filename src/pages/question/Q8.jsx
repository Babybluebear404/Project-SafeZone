...
const Q8 = () => {
  ...
  const questions = [
    "ในช่วง 1 เดือนที่ผ่านมา มีบางช่วงไหมคะที่รู้สึกว่า ถ้าหายไป หรือไม่ต้องอยู่ตรงนี้แล้ว อาจจะดีกว่า",
    "ในช่วง 1 เดือนที่ผ่านมา มีบางครั้งไหมคะที่รู้สึกอยากทำร้ายตัวเอง หรือรู้สึกว่าการเจ็บกายจะทำให้ใจสบายขึ้นบ้าง",
    "ในช่วง 1 เดือนที่ผ่านมา เคยมีช่วงที่คิดถึงเรื่องการจากไป หรือความคิดแบบนั้นแวะเข้ามาในใจไหมคะ",
    "ตอนนี้ คุณคิดว่าคุณพอจะควบคุมความคิดแบบนั้นได้ไหมคะ หรือรู้สึกมั่นใจว่าคงจะไม่ลงมือทำอะไรตามความคิดนั้นในตอนนี้?",
    "ในช่วง 1 เดือนที่ผ่านมา เคยคิดวางแผน หรือลองคิดไว้จริงจังว่าจะจากไปอย่างไรบ้างไหมคะ",
    "ในช่วง 1 เดือนที่ผ่านมา มีช่วงที่ได้เริ่มเตรียมอะไรบางอย่างไว้ เพื่อทำร้ายตัวเองหรือจากไปอย่างตั้งใจบ้างไหมคะ",
    "ในช่วง 1 เดือนที่ผ่านมา มีบางช่วงที่อาจเผลอทำร้ายตัวเองบ้างไหมคะ แม้จะไม่ได้ตั้งใจให้ถึงกับหายไปก็ตาม",
    "ในช่วง 1 เดือนที่ผ่านมา มีเหตุการณ์ไหนที่ได้ลองพยายามทำอะไรบางอย่าง เพื่อตั้งใจจะจากไปจริง ๆ บ้างไหมคะ",
    "ตั้งแต่ในอดีตจนถึงตอนนี้ เคยมีช่วงหนึ่งไหมคะที่เคยพยายามจะจากไปจริง ๆ"
  ];
